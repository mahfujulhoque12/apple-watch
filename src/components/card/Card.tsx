      ...
      <div className="flex flex-col gap-6">
        ...
        {visibleCards.map((card) => {
          ...
          return (
            <div
              key={card.id}
              className="relative flex items-center gap-4 border border-gray-700 rounded-xl p-4 bg-[#222831] shadow-sm"
            >
              {/* Delete Button */}
              <button
              ...
              <div className="flex flex-col flex-1">
                ...
                <div className="flex items-center gap-3 mt-2">
                  <button
                    ...
                    className="bg-gray-400 px-2 rounded hover:bg-gray-300"
                  >
                    −
                  </button>
        ...
        {visibleCards.length > 0 ? (
          <div className="border-t pt-4 mt-4">
            <div className="flex justify-between text-gray-300 text-base mb-2">
              <span>Subtotal</span>
