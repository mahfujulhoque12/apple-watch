...
const Specification = () => {
  ...
  <p>No image found</p>
        ...
        {/* Specification Text */}
        <div>
          <h2 className="text-2xl font-bold mb-3 text-gray-200 flex items-start gap-3">
           
            {description.title}
            </h2>
 
            {description.specs.map((item: string, index: number) => (
              <p className='text-base font-medium text-gray-300 my-2.5 flex items-start gap-1' key={index}>  <span className="min-w-[1.5rem] pt-1 text-gray-300">
