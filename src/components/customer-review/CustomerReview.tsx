...
const CustomerReview = () => {
  ...
  return (
    <MaxWidthWrapper>
      <h2 className="text-2xl font-bold text-center my-5 text-gray-200">
        Customer Reviews
      </h2>
          ...
          <CarouselContent>
            {reviews.map((review) => (
              <CarouselItem key={review.id}>
                <div className="p-4 rounded-md border border-gray-700 shadow-sm hover:shadow-md transition">
                  {/* Name */}
