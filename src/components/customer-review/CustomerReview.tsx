...
const CustomerReview = () => {
  ...
  return (
    <MaxWidthWrapper>
      <h2 className="text-2xl font-bold  my-5 text-gray-200">
        Customer Reviews
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-5 relative">
        <Carousel>
            ...
            {reviews.map((review) => (
              <CarouselItem key={review.id}>
                <div className=" rounded-md border border-gray-700">
                  <div className="px-4 pt-4">
                    ...
                    <div className="flex items-center gap-3">
                      {review.img ? (
                        ...
                        <FaUserCircle size={50} color="#183B4E" />
                      )}
                      ...
                      <div>
                        ...
                        <p className="text-[#183B4E] flex gap-1 mt-1">
                    ...
                    <div className="flex items-center relative">
                      <p className="h-[2px] w-[70%] bg-[#183B4E] mt-3"></p>
                      <p className="text-[#183B4E] absolute right-[26%] top-1 ">
                  ...
                  {/* Star rating */}
                  <div className="mt-3 bg-[#183B4E]/10 p-4">
          ...
          <CarouselPrevious className="hover:bg-[#183B4E] hover:text-white border-gray-700" />
          <CarouselNext className="hover:bg-[#183B4E] hover:text-white border-gray-700" />
        </Carousel>
        {modalImage && (
          <div
