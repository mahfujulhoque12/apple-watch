          ...
          {videoData.map(({ url, title, des }, index) => {
            ...
            return (
              <div
                ...
                data-index={index}
                className="p-4 relative shadow-md z-10 border border-gray-700 rounded-lg hover:shadow-lg transition-shadow duration-300"
              >
                ...
                <p className="text-gray-300 text-sm font-normal">{des}</p>
              </div>
            );
          })}
        </div>
