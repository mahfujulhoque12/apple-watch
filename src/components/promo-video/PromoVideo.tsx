...
const PromoVideo: React.FC = () => {
  ...
  return (
    <section className="mt-5">
      <MaxWidthWrapper>
        <h2 className="text-gray-200 text-2xl font-bold  pb-5">
          Promo Video
        </h2>
          ...
          {videoData.map(({ url }, index) => {
            ...
            return (
              <div
                ...
                data-index={index}
                className="relative shadow-md z-10 border border-gray-700 rounded-lg hover:shadow-lg transition-shadow duration-300"
              >
