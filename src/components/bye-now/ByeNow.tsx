...
const ByeNow = () => {
  ...
  return (
    ...
    <MaxWidthWrapper>
      <div className="my-10 max-w-2xl mx-auto bg-[#222831] p-6 rounded-lg shadow-md border border-gray-700">
        <h2 className="text-2xl font-bold mb-4 text-center text-gray-200">Buy Your Gadget</h2>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            <label className="block text-gray-300 font-medium mb-1">Quantity (in packs)</label>
            <input
              type="number"
              {...register('quantity', {
          ...
          <div>
            <label className="block text-gray-300 font-medium mb-1">Delivery Address</label>
            <textarea
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#183B4E] hover:bg-[#000000] text-white font-semibold py-2 rounded-md  cursor-pointer transition-all duration-300"
          >
